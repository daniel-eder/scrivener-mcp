...
export class EmotionEnhancer {
	...
	private detectTellingPatterns(
		...
		const emotionPatterns = [
			{
				regex: /\b(he|she|they|I)\s+(was|were|am|is)\s+(angry|mad|furious)\b/gi,
				type: 'emotion',
				emotion: 'anger',
			},
			{
				regex: /\b(he|she|they|I)\s+(was|were|am|is)\s+(sad|depressed|unhappy)\b/gi,
				type: 'emotion',
				emotion: 'sadness',
			},
			{
				regex: /\b(he|she|they|I)\s+(was|were|am|is)\s+(happy|joyful|excited)\b/gi,
				type: 'emotion',
				emotion: 'happiness',
			},
			{
				regex: /\b(he|she|they|I)\s+(was|were|am|is)\s+(scared|afraid|frightened)\b/gi,
				type: 'emotion',
				emotion: 'fear',
			},
		];
		...
		const physicalPatterns = [
			{
				regex: /\b(he|she|they|I)\s+(was|were|am|is)\s+(tired|exhausted)\b/gi,
				type: 'physical',
				emotion: 'fatigue',
			},
			{
				regex: /\b(he|she|they|I)\s+(was|were|am|is)\s+(hungry|starving)\b/gi,
				type: 'physical',
				emotion: 'hunger',
			},
		];
	...
	private generatePhysicalResponse(emotion: string, originalText: string): string {
		...
		if (options) {
			...
			return response.replace(
				/\b(he|his|him|she|her|they|their|them|I|my|me)\b/gi,
				(match) => {
					if (pronoun === 'she') {
